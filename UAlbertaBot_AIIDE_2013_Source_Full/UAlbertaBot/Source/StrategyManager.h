...
class StrategyManager 
{
	...
	const	std::string			getProtossCarrierOpeningBook() const;
...
public:
	...
	enum { ProtossZealotRush=0, ProtossDarkTemplar=1, ProtossDragoons=2, ProtossCarrier=3, NumProtossStrategies=4 };
