...
const double Neural::getUCBValue(const size_t & strategy) const
{
...
const std::string Neural::getOpeningBook() const
{
	if (selfRace == BWAPI::Races::Protoss)
	{
...
const int Neural::defendWithWorkers()
{
...
const bool Neural::doAttack(const std::set<BWAPI::Unit *> & freeUnits)
{
...
const bool Neural::expandProtossZealotRush() const
{
...
const MetaPairVector Neural::getBuildOrderGoal()
{
...
const MetaPairVector Neural::getProtossDragoonsBuildOrderGoal() const
{
	// the goal to return
	MetaPairVector goal;
...
const MetaPairVector Neural::getProtossDarkTemplarBuildOrderGoal() const
{
	// the goal to return
	MetaPairVector goal;
...
const MetaPairVector Neural::getProtossZealotRushBuildOrderGoal() const
{
	// the goal to return
	MetaPairVector goal;
...
const MetaPairVector Neural::getTerranBuildOrderGoal() const
{
	// the goal to return
...
const MetaPairVector Neural::getZergBuildOrderGoal() const
{
	// the goal to return
	std::vector< std::pair<MetaType, UnitCountType> > goal;
...
const int Neural::getCurrentStrategy()
{
